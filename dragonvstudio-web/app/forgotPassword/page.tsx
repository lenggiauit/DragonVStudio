...
export async function generateMetadata(
  ...
  return {
    ...
    openGraph: {
      ...
      title: 'Dragon V Studio',
      description: 'Forgot Password - Dragon V Studio',
      url: appSetting.SiteUrl + '/forgotPassword',
    },
  }
}
const ForgotPassword: NextPage = async () => {
  return (
    <>
      <AuthLayout>
        <div className='col-lg-7 col-xl-8 d-flex justify-content-center align-items-center min-vh-lg-100 min-vh-md-100 min-vh-sm-100'>
          <div className='flex-grow-1 mx-auto' style={{ maxWidth: '28rem' }}>
            <div className='text-center mb-5 mb-md-7'>
              ...
              <h1 className='h2'>
                <Translation tid='forgotPassword_title' />
              </h1>
              <p>
                <Translation tid='forgotPassword_des' />
              </p>
            </div>
            <ForgotPasswordForm />
          </div>
