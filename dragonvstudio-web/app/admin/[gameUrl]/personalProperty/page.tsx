...
import AdminPersonalProperty from '@/components//admin/personalProperty'
...
const AdminGamePPPage: NextPage = async () => {
...
export default AdminGamePPPage
